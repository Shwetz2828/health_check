...
# If models were loaded successfully, continue with the rest of the code
if classifier and rf:
    warnings.warn("Models loaded successfully.")
    # Further code execution here
else:
    warnings.warn("Failed to load one or more models. Check error messages for details.")
